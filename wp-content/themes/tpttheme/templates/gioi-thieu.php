        ...
        <div class="col-md-7">
          ...
          <form class="about-infor-form form-horizontal">
            <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4 control-input">
                  <input type="text" class="form-control gia_input" name="dttt" id="dttt" onkeyup="tkkt()" placeholder="">
                </div>
              </div>
              ...
              <div class="form-group ">
                ...
                <div class="col-sm-4 control-input">
                  <input type="text" class="form-control gia_input" name="st" id="st" onkeyup="tkkt()" placeholder="">
                </div>
              </div>
            </div>
          </form>
          ...
          <div class="box-dutoan cus">
            ...
            <div class="btn-type-design">
              <a  id="tktg" onclick="tktg()" class="btn btn-primary--cus">Thiết kế trọn gọi</a>
